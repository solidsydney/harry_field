...
ActiveRecord::Schema.define(:version => 20130110095412) do
  ...
  add_index "assessment_scores", ["student_id", "batch_id", "descriptive_indicator_id", "exam_id"], :name => "score_index", :limit => {"student_id"=>nil, "descriptive_indicator_id"=>nil, "exam_id"=>nil, "batch_id"=>nil}
  ...
  add_index "batches", ["is_deleted", "is_active", "course_id", "name"], :name => "index_batches_on_is_deleted_and_is_active_and_course_id_and_name", :limit => {"course_id"=>nil, "is_active"=>nil, "is_deleted"=>nil, "name"=>nil}
  ...
  add_index "cce_reports", ["observable_id", "student_id", "batch_id", "exam_id", "observable_type"], :name => "cce_report_join_index", :limit => {"student_id"=>nil, "observable_id"=>nil, "observable_type"=>nil, "exam_id"=>nil, "batch_id"=>nil}
  ...
  add_index "students", ["nationality_id", "immediate_contact_id", "student_category_id"], :name => "student_data_index", :limit => {"immediate_contact_id"=>nil, "nationality_id"=>nil, "student_category_id"=>nil}
